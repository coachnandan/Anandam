...
export default function OtherClubMemberEditModal({ member, onClose, onSave }) {
  ...
  useEffect(() => {
    if (member) {
      ...
      setValue('sameAsMobile', member.mobile === member.whatsapp);
      setValue('club_name', member.club_name);
      setValue('referred_by', member.referred_by);
      setValue('reason', member.reason);
      setValue('remarks', member.remarks);
      setValue('visit_date', member.visit_date);
    }
  }, [member, setValue]);
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-xl border border-gray-200 shadow-lg w-full max-w-xl overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
          <h3 className="text-lg font-bold text-gray-900">Edit Other Club Member</h3>
